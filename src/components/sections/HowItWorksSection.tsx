...
type Step = { imageUrl?: string | null; imageAlt?: string | null; heading: string; body: string }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {display.map((step, i) => (
            <div key={i} className="flex flex-col items-center text-center">
              <div className="relative w-24 h-24 rounded-full overflow-hidden border border-white/60 mb-5 bg-white/50">
                <Image
                  src={step.imageUrl ?? FALLBACK_PHOTOS[i]}
